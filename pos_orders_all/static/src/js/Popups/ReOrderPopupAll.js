odoo.define('pos_orders_all.ReOrderPopupAll', function(require) {
	'use strict';
	...
	class ReOrderPopupAll extends AbstractAwaitablePopup {
		constructor() {
			super(...arguments);			
		}
	...
	ReOrderPopupAll.template = 'ReOrderPopupAll';
	Registries.Component.add(ReOrderPopupAll);
	return ReOrderPopupAll;
});
