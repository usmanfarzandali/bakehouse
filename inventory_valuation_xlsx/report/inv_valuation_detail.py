...
class CODPaymentXlsx(models.AbstractModel):
    _name = 'report.inventory_valuation_xlsx.inv_value_detail_template'
    ...
    def generate_xlsx_report(self, workbook, report_detail, wizard_data):
        ...
        worksheet.merge_range('A2:N3', 'Inventory OPSI Report', main_merge_format)
        ...
        worksheet.write_string(row, col+13, 'Closing Quantity', format_data_header)
        ...
        for record in move_lines_record:
            ...
            if rec_check:
                ...
                worksheet.write_number(row, col+13, closing, format_data_right)
                row += 1
