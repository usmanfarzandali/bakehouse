			   ...
			   ////////////////////////////////////////////////////////////////////////////
				...
				else if(schemes[s].scheme_type == 'unit_price_disc_percent')
				{
					...
					for (var x in orderline_data)
						...
						//DISPLAY MERGED ARRAY
						for(var data in temp_orderline_data)
						{
					...
					for(var prod in scheme_prod_list)
						{
					...
					for(var x in qty_arranged_dict)
						{
...
//					    		disc = ((total_percentage/volume_singleton_array[p].volume_price)*100).toFixed(2)
					    		...
					    		if(stock_flag == true)
					    		{
						    		...
						    		order.add_product(line_product,{price:disc,merge:true,merge_flag:true,stock:true});
					    			stock_flag = false;
					    		}
					    		else
					    			{
					    			var line_product =pos_obj.db.get_product_by_id(remained_product_ids[p]);
						    		order.add_product(line_product,{price:disc,merge:true,merge_flag:true});
					    			}
