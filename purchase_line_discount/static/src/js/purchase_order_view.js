odoo.define('purchase_line_discount.pol_discount', function (require) {
    "use strict";
    ...
    const PurchaseOrderFormController = FormController.extend({
        custom_events: _.extend({}, FormController.prototype.custom_events, {
            open_discount_wizard_purchase: '_onOpenDiscountWizardPurchase',
        }),

        _onOpenDiscountWizardPurchase(ev) {
